        ...
        <div class="flex flex-1 flex-col p-4">
            <div class="flex items-center justify-between">
                ...
                @if ($showFavorite && $favoriteRoute)
                    <form action="{{ $favoriteRoute }}" method="POST" class="-mr-1">
                        @csrf
                        <button type="submit" class="group/heart p-1 transition-transform hover:scale-110 active:scale-95">
                            @if ($isFavorited)
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                    class="h-5 w-5 text-red-500 drop-shadow-sm">
                            ...
                            @else
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="h-5 w-5 text-zinc-400 group-hover/heart:text-red-400">
